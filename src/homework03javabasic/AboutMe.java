...
public class AboutMe {
	...
	public static void main(String[] args) {
		...
		System.out.println("My is name " + roney.my_name + "; and my age " + roney.age + ";my sex " + roney.sex
				+ "; my 7days income " + roney.myWeeklyIncome);
		System.out.println("\nMy is name " + roney.my_name + " ;\nand my age " + roney.age + " ; my sex " + roney.sex
				+ " ; my 7days income " + roney.myWeeklyIncome);

	}
		//	https://github.com/shahab6671/HomeWorkJavaCore/tree/master/src/homework03javabasic
